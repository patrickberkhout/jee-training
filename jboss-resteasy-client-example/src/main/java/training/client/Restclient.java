...
public class Restclient {
	...
	public void testCustomerResource() throws Exception {
		...
		BASEURL = "http://" + host + ":8181/jboss-resteasy-example/rest-service/";
	...
	/**
	 * Use the GET command to retrieve the Customer using the passed in
	 * connection
	 * 
	 * @param newCustURL
	 * @throws Exception
	...
	public void updateCustomer(String updateCustURL) throws Exception {
		...
		updateCustomer.setFirstName("Randyolph"); // name changed from Randy to
													// Randolph
